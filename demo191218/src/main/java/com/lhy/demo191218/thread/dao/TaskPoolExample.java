...
* @author liuhaoyang
*/
public class TaskPoolExample extends AbstractExample {
    /**
     * task_pool
     */
    ...
    public static class Criteria extends GeneratedCriteria {
        private TaskPoolExample example;

        protected Criteria(TaskPoolExample example) {
            super();
            this.example = example;
        }

        public TaskPoolExample example() {
            return this.example;
        }
    }
